...
export default function IllusiRewindComponent() {
	...
	return (
		<View style={{ height: height, justifyContent: "center", alignItems: "center" }}>
			...
			<IImage fade={{ percent: 300, middle_opacity: 0.0, end_opacity: 0.9, color: colors.primary }} blurRadius={10} source={0} style={{ height: height, bottom: 0, position: "absolute", zIndex: 0, resizeMode: "center" }} />
		</View>
	);
}
