...
import { SetState, Track } from '@illusive/types';
...
export default function TrackInfoModal(props: {
    ...
    const data: [string, any][] = [
        ...
        ["Track Range", `${duration_to_string(props.modal_data.track_data?.meta?.begdur ?? 0)} - ${duration_to_string(props.modal_data.track_data?.meta?.enddur ?? (props.modal_data.track_data?.duration ?? 0))}`],
