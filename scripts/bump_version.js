...
const newAppConfig = appConfig.replace(/version: "\d+\.\d+\.\d+"/, `version: "${next}"`);
...
const newPlist = plist.replace(/(<key>CFBundleShortVersionString<\/key>\s*<string>)\d+\.\d+\.\d+(<\/string>)/, `$1${next}$2`);
if (newPlist === plist) {
