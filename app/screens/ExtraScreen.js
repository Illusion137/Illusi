...
function ExtraScreen(props) {
	...
	return (
		<View style={styles.topcontainer}>
			...
			<ScrollView>
				<ExtrasSectionButton text='Backup, Recover, & Transfer' icon='cloud-outline' onPress={() => console.log('Pressed')}/>
				...
				<ExtrasSectionButton text='Settings' icon='settings-outline' onPress={() => console.log('Pressed')}/>
				<View style={styles.line}></View>
				
				<ExtrasSectionButton text='Sleep Timer' icon='timer-outline' onPress={() => console.log('Pressed')}/>
				<View style={styles.line}></View>
				
				<ExtrasSectionButton text='Youtube Login' icon='logo-youtube' onPress={() => console.log('Pressed')}/>
				...
				<ExtrasSectionButton text='Import Manager' icon='download' onPress={() => console.log('Pressed')}/>
