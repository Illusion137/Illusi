...
export default function IllusiExplore(){
    ...
    async function refresh_new_releases(): Promise<(CompactPlaylist|ResponseError)[]|ResponseError|ResponseError>{
        ...
        set_new_releases(filtered_new_releases);
        return new_releases.flat();
    }
    ...
    return (
        <ScrollView>
            ...
            <AlbumList second_line_type="ARTIST" refresh={{last_refresh: new Date(), refresh_data: refresh_new_releases}} title="New Releases" else_type="ALBUM" albums={new_releases}/>
