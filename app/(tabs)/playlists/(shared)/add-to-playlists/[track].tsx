...
import { Playlist, type Track } from '@illusive/types';
...
export default function AddToPlaylistsModal() {
    ...
    return(
        <View style={{flex: 1, backgroundColor: colors.background}}>
            ...
            <Text numberOfLines={1} style={{marginHorizontal: 20, bottom: 60, color: colors.text, fontWeight: 'bold', fontSize: 24}}>{_track?.title || ""}</Text>
