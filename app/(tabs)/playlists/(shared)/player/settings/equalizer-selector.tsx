...
export default function EqualizerSelector() {
	...
	function update_equalizer_preset(preset: Prefs.EqualizerPreset) {
		...
		TrackPlayer.setEqualizer(Prefs.equalizer_presets[preset] as unknown as number[]);
	}
	...
	return (
		<>
			...
			<View style={{ height: 5 }} />
			<MultiOption current_value={current_equalizer_preset} options={all_equalizer_presets} on_press={(preset) => update_equalizer_preset(reinterpret_cast<Prefs.EqualizerPreset>(preset))} />
		</>
	);
}
