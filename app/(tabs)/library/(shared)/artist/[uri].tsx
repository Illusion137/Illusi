		...
		<>
			...
			<ScrollView bounces={false}>
				<View style={{ width: "100%", height: 300 }}>
					...
					<Text style={{ position: "absolute", bottom: -13, fontSize: 15, fontWeight: "light", paddingLeft: 20, color: colors.subtext }}>
				...
				<View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginHorizontal: 20 }}>
					{artist_data.is_following !== undefined ? (
						<TouchableOpacity onPress={on_watch_unwatch} style={{ borderRadius: 40, backgroundColor: colors.text, justifyContent: "center", alignItems: "center", padding: 10, paddingHorizontal: 18 }}>
							<Text style={{ color: colors.background, fontSize: 15, fontWeight: "500" }}>{watched ? "Unwatch" : "Watch"}</Text>
						</TouchableOpacity>
					) : (
						<View />
					)}
					<IoniconsTouchableOpacity icon_name="play-circle-sharp" icon_color={colors.primary} icon_size={60} on_press={play_artist} />
				</View>
