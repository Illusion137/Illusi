...
export default function ExtrasLayout() {
	return (
		<Stack screenOptions={{ headerShown: true }}>
			...
			<Stack.Screen name="shuffler-test" options={{ title: "Shuffler Test", headerShown: true, presentation: "formSheet" }} />
			...
			<Stack.Screen name="link" options={{ title: "Link", headerShown: false, presentation: "formSheet" }} />
