	...
	return (
		<View style={{ backgroundColor: colors.background, width: "100%", flex: 1 }}>
			<SectionList
				...
				ListHeaderComponent={<View style={styles.line_long} />}
				ListFooterComponent={
					<>
						...
						<ExtrasSectionButton
							show_arrow={false}
							text="Super Speed Sample Library"
							icon="search-circle"
							onPress={async () => {
								await speed_sample_unavailable_tracks(GLOBALS.global_var.sql_tracks, true);
								GLOBALS.global_var.bottom_alert?.("FINISHED SPEED SAMPLING", "INFO");
						...
						<ExtrasSectionButton
							show_arrow={false}
							text="Convert all YouTube Tracks to YouTube Music"
						...
						<ExtrasSectionButton
							show_arrow={false}
							text="Fix Tracks Added Metadata"
							icon="construct-outline"
							onPress={async () => {
