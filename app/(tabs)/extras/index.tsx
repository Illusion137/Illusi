	...
	return (
		<View style={styles.top_container}>
			...
			<ScrollView>
				...
				<View style={styles.line_short} />
				<SegmentedControl values={Prefs.all_themes().map((val) => single_case(val))} selectedIndex={Prefs.all_themes().findIndex((item) => item === Prefs.get_pref("theme"))} onChange={async (event) => await change_theme(event)} style={{ backgroundColor: colors.background }} fontStyle={{ color: colors.text }} />
